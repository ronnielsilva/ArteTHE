  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin">
        ...
        <input type="password" class="input-block-level" placeholder="Confirmar Password">
        <label>Sexo
        <input type="radio" id="M" value="masculino">      Masculino
        <input type="radio" id="F" value="Feminino">      Feminino
        </label>
